    ...
    <div>
      ...
      <header>
        ...
        <nav>
          ...
          <li><a href="#" class="btn">Doctor</a></li>
          <li><a href="#" class="btn">Pharmacy</a></li>
          <li><a href="#" class="btn">Manager</a></li>
          <li><a href="#" class="btn">Accountant</a></li>
          <li><a href="#" class="btn">Registrar</a></li>
          <li><a href="#" class="btn">Laboratory</a></li>
